...
const launchAnimations = require("./animations/launchAnimations").default;
...
const getDistance = require("./getDistance");
  ...
  class Board {
    ...
    addShortestPath(targetNodeId, startNodeId) {
    ...
    drawShortestPathTimeout(targetNodeId, startNodeId, type) {
      let board = this;
      let currentNode;
    ...
    toggleTutorialButtons() {
      ...
      function nextPreviousClick() {
        if (counter === 1) {
          ...
          document.getElementById("tutorial").innerHTML = `<h3>Enjoy!</h3><h6>I hope you have just as much fun playing around with this visualization tool as I had building it!</h6></p><div id="tutorialCounter">${counter}/8</div><button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`;
